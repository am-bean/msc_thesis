...
parser.add_argument("--first-checkpoint", type=str, default='l2_4')
parser.add_argument('--cp-filepath', type=str, default='C:/Users/Andre/ray_results/DQN/aws/')

if __name__ == "__main__":
    '''Takes a pre-trained checkpoint and compares with the rule-based version competing head to head.
